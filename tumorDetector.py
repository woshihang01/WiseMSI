...
def main(args):
    ...
    for i in folds:
        ...
        train_dataset = WSI_Patches_Image(train_list, args.patch_image_path, training=True, maximum=100)
        val_dataset = WSI_Patches_Image(val_list, args.patch_image_path, training=False)
        test_dataset = WSI_Patches_Image(test_list, args.patch_image_path, training=False)
...
parser.add_argument('--task', default='tumor_classifier', type=str, choices=['tumor_classifier'])
