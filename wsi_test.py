...
def validate(model, loader, n_classes, loss_fn=None):
    ...
    #          lw=lw,
    #          label='AUROC:{:0.4f} (95% CI {:0.4f}-{:0.4f})'.format(0.9302,0.9161,0.9442))  ###假正率为横坐标，真正率为纵坐标做曲线
    ...
    # plt.savefig(os.path.join(args.results_dir, args.exp_code+"_s1", 'test'+args.k+'.png'))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pt_files_dir', default='C:/RESULTS_TUMOR_STAIN_NORM/patches', type=str,
                        help='h5file directory')
    parser.add_argument('--patches_dir', default='C:/RESULTS_TUMOR_STAIN_NORM/patches', type=str,
    ...
    parser.add_argument('--exp_code', type=str, help='experiment code for saving results', default='msi_classifier_2021_08_24')
    ...
    csv_path = 'dataset_csv/dataset_2021.09.01_从未做过测试集的数据.csv'
