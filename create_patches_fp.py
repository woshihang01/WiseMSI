...
def seg_and_patch(source, save_dir, patch_save_dir, mask_save_dir, stitch_save_dir,
                  ...
                  stitch=False,
                  patch=False, auto_skip=True, process_list=None, only_tumor=False, normalize=False):
    ...
    for i in range(total):
        ...
        WSI_object = WholeSlideImage.WholeSlideImage(full_path)
        ...
        if patch:
            current_patch_params.update({'patch_level': patch_level, 'patch_size': patch_size, 'step_size': step_size,
                                         'save_path': patch_save_dir, 'only_tumor': only_tumor, 'normalize': normalize})
...
if __name__ == '__main__':
    ...
    seg_times, patch_times = seg_and_patch(**directories, **parameters,
                                           ...
                                           only_tumor=args.only_tumor, normalize=args.normalize)
